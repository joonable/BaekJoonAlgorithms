...
#ifndef BAEKJOONALGORITHMS_PRO6591_H
#define BAEKJOONALGORITHMS_PRO6591_H
...
int pro6591(){
    ...
    while( true){
        ...
        while(n <= N){
            nCm[flag][0] = 1;
            for( int m = 1 ; m < n ; ++m ){
                nCm[flag][m] = ((nCm[!flag][m - 1] + nCm[!flag][m]));
            }
            nCm[flag][n] = 1;
            flag = (!flag);
            n++;
        }
        cout<<(string)nCm[!flag][M]<<endl;
    }
...
#endif //BAEKJOONALGORITHMS_PRO6591_H
